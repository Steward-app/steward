...
# source: proto/steward/asset.proto
...
_ASSET.fields_by_name['organization'].message_type = proto_dot_steward_dot_organization__pb2._ORGANIZATION
...
Asset = _reflection.GeneratedProtocolMessageType('Asset', (_message.Message,), {
  'DESCRIPTOR' : _ASSET,
  '__module__' : 'proto.steward.asset_pb2'
