...
# source: proto/steward/maintenance.proto
...
_MAINTENANCE.fields_by_name['asset'].message_type = proto_dot_steward_dot_asset__pb2._ASSET
_MAINTENANCE.fields_by_name['schedule'].message_type = proto_dot_steward_dot_schedule__pb2._SCHEDULE
_UPDATEMAINTENANCEREQUEST.fields_by_name['maintenance'].message_type = _MAINTENANCE
_LISTMAINTENANCESREQUEST.fields_by_name['asset'].message_type = proto_dot_steward_dot_asset__pb2._ASSET
...
Maintenance = _reflection.GeneratedProtocolMessageType('Maintenance', (_message.Message,), {
  ...
  '__module__' : 'proto.steward.maintenance_pb2'
